...
var $insert = function (context) {
    return function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var collectionName, password, result, collection;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.insert(payload)];
                    case 1:
                        result = _a.sent();
                        collection = context.loki.getCollection(collectionName);
                        result[this.entity].forEach(function (item) {
                            var jsonData = item.$toJson();
                            if (_this.AES) {
                                _this.AES.forEach(function (key) {
                                    if (jsonData[key]) {
                                        if (!password) {
                                            throw new Error("Cannot insert data. The " + collectionName + " model contains encrypted fields ( " + _this.AES + ").\n                               The object passed to $insert() method has to have a password property set.");
                                        }
