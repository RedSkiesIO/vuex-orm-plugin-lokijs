# vuex-orm-lokijs Contributing Guide
...
### Work Step Example
- Fork the repository from [nsh-core/vuex-orm-lokijs](https://github.com/nsh-core/vuex-orm-lokijs) !
- Create your topic branch from `develop`: `git branch my-new-topic origin/develop`
- Add codes and pass tests !
- Commit your changes: `git commit -am 'Add some topic'`
- Push to the branch: `git push origin my-new-topic`
- Submit a pull request to `develop` branch of `nsh-core/vuex-orm-lokijs` repository !
